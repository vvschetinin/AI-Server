...
<form action="#" id="modal-form" class="form-overlay modal-form">
  ...
  <div class="form-footer mb-2">
    ...
    <input type="email" class="form-target_page-email" name="<?= htmlspecialchars($honeypots['hp_email']) ?>" value=""
      aria-hidden="true" autocomplete="off">
    <input type="tel" class="form-target_page-phone" name="<?= htmlspecialchars($honeypots['hp_tel']) ?>" value=""
      aria-hidden="true" autocomplete="off">
  </div>
</form>
<!-- End Form -->
