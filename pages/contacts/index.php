            ...
            <div class="col-100 col-md-90 col-lg-75 pr-3--md">
              ...
              <article class="text-right--md">
                ...
                <p class="sendrules">
                  ...
                  информацию, включая адрес электронной почты и номер
                  телефона, а также другие удобные для вас способы связи. Это можно сделать через контактную форму,
                  вызвав ее кнопкой "Свяжитесь со мной". Для пересылки
                  файлов различных форматов, текстов содержащих ссылки и изображений - прошу воспользоваться электронной
                  почтой <span><a href="mailto:info@vschetinin.ru">info@vschetinin.ru</a></span>
                </p>
