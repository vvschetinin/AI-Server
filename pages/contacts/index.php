    ...
    <main class="site-content">
      ...
      <section class="hero hero--large flex items-center">
        <figure class="hero-media bg--cover" style="background-image: url(/assets/images/contacts/bg-contacts.webp)"
          role="img" aria-label="Рабочее пространство веб-разработчика: обсуждение проекта" id="hero-figure-contact">
        </figure>
        <div class="hero-container">
          <div class="hero-content">
            <h1 class="hero-title">
              <!-- Четкое позиционирование для поиска -->
              <span class="sectorname">Контакты веб-разработчика</span>
              Обсудим ваш проект
              <!-- Сохраняем дружелюбный тон + добавляем удаленный формат -->
              <span>за чашкой кофе или онлайн</span>
            </h1>
            <article class="hero-text">
              <h2 class="p-article color-white">
                Ищете партнера для <strong>создания сайта</strong> или автоматизации бизнеса? Просто напишите мне. Давайте обсудим задачи и найдем решение, которое выведет ваш бизнес на новый уровень.
              </h2>
              <p class="font-middle">Свяжитесь для бесплатной консультации уже сегодня!</p>
            </article>
          </div>
        </div>
          ...
          <div class="row element-animation-up">
            ...
            <div class="col-100 col-md-90 col-lg-75 pr-3--md">
              <div class="contact-description text-right--md">
                <!-- Меняем вопрос на утверждение услуги -->
                <h2 class="h2-title deco-line">Заказать разработку или внедрение AI</h2>
              </div>
              <article class="text-right--md">
                <!-- Предлагаем выгоду: "расчет стоимости" вместо "предоставить описание" -->
                <h2 class="p-article">Опишите задачу для предварительного расчета стоимости и сроков.</h2>
                <p class="sendrules">
                  Чтобы я мог быстрее вникнуть в суть, укажите в заявке масштаб проекта: нужен ли вам <strong>корпоративный сайт</strong>, интернет-магазин или
                  <strong>интеграция чат-бота</strong>. Оставьте телефон или мессенджер для оперативной связи.<br><br>
                  Если у вас уже есть готовое <strong>Техническое задание (ТЗ)</strong>, макеты дизайна или ссылки на примеры (референсы), пожалуйста, отправьте их напрямую на email: <span><a href="mailto:info@vschetinin.ru" style="font-weight: 700;">info@vschetinin.ru</a></span>.
                </p>
                <p>
                  Я проведу анализ вашей задачи и представлю готовое предложениее по реализации в течение 24 часов.
                </p>
              </article>
              <div class="button-wrap text-right--md mt-3">
                <button class="start-project-btn display-inline-block js-startproject">Начать проект</button>
              </div>
            </div>
          </div>
        </div>
