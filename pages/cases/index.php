      ...
      <section class="hero hero--small">
        <div class="hero-container">
          <div class="hero-content">
            <h1 class="hero-title">
              <!-- Внедряем основной идентификатор раздела -->
              <span class="sectorname">Портфолио веб-разработчика</span>
              Реализованные проекты и кейсы
              <!-- Перечисляем конкретные направления работ для охвата семантики -->
              <span>Разработка сайтов, AI-боты и SEO</span>
            </h1>
            <div class="hero-buttons">
              <!-- Делаем текст кнопки более коммерческим -->
              <a class="btn btn--purple" href="/services/">Заказать аналогичный проект</a>
            </div>
          </div>
        </div>
      ...
      <section class="section-type s-casestop bg-dark">
        <div class="container--middle">
          <div class="row content-block element-animation-up">
            <div class="col-100">
              <!-- Прямое вхождение запроса в H2 -->
              <h2 class="h2-title deco-line mb-2">Разработка сайтов и адаптивная верстка</h2>
              <article>
                <h2 class="p-article mb-0">Примеры веб-разработки и результаты внедрения:</h2>
                <p>
                  От лендингов с высокой скоростью загрузки до сложных порталов с <strong>интеграцией AI-чат-ботов</strong>. Ниже представлены примеры реализованных проектов, где я решал задачи по <strong>технической оптимизации сайтов</strong>, улучшению юзабилити и росту конверсии. Нужен современный ресурс, который продает? Свяжитесь со мной для обсуждения деталей.
                </p>
              </article>
            </div>
          </div>
              ...
              <div class="workgrid">
                <div class="workgrid-inner">
                  ...
                  <div class="mywork-item">
                    <!-- Добавлен title для SEO ссылки -->
                    <a href="/samples/beautyshop/" target="_blank" class="grid-item work-item"
                      title="Адаптивная верстка интернет-магазина косметики">
                      <div class="inner">
                        <!-- Добавлен alt для поиска по картинкам -->
                        <div class="grid-item-image bg--cover"
                          style="background-image:url(/assets/images/cases/demo/beautyshop/prev.jpg.webp)"
                          role="img" aria-label="Сайт магазина S-MILLER: пример верстки"></div>
                        <div class="work-logo">
                          <span>S-MILLER</span>
                        </div>
                      </div>
                  ...
                  <!-- ================================== -->
                  <div class="mywork-item">
                    <a href="https://vacancy.zmk-mami.ru/" target="_blank" rel="nofollow"
                      class="grid-item work-item" title="Разработка HR-портала для завода">
                      <div class="inner">
                        <div class="grid-item-image bg--cover"
                          style="background-image:url(/assets/images/cases/demo/zmk/zmk-vacancy.webp)"
                          role="img" aria-label="Корпоративный сайт ЗМК МАМИ"></div>
                        <div class="work-logo">
                          <span>ЗМК МАМИ</span>
                  ...
                  <div class="mywork-item">
                    <a href="/samples/tesla/" target="_blank" class="grid-item work-item"
                      title="Промо-сайт Tesla: современный дизайн">
                      <div class="inner">
                        <div class="grid-item-image bg--cover"
                          style="background-image:url(/assets/images/cases/demo/tesla/tesla-logo.webp)"
                          role="img" aria-label="Демонстрационный сайт Tesla"></div>
                        <div class="work-logo">
                  ...
                  <div class="mywork-item">
                    <a href="/samples/cartrans/" target="_blank" class="grid-item work-item"
                      ...
                      <div class="inner">
                        <div class="grid-item-image bg--cover"
                          style="background-image:url(/assets/images/cases/demo/cartrans/bg-cartrans.jpg.webp)"
                          role="img" aria-label="Сайт Авто Логистик"></div>
                        <div class="work-logo">
                  ...
                  <div class="mywork-item">
                    <a href="/samples/tellus/" target="_blank" class="grid-item work-item"
                      title="Сайт промышленной компании Tellus">
                      <div class="inner">
                        <div class="grid-item-image bg--cover"
                          style="background-image:url(/assets/images/cases/demo/tellus/prev.jpg.webp)"
                          role="img" aria-label="Проект Tellus Utilites"></div>
                        <div class="work-logo">
                  ...
                  <div class="mywork-item">
                    <a href="/samples/fred/" target="_blank" class="grid-item work-item"
                      title="Лендинг для бренда Fred">
                      <div class="inner">
                        <div class="grid-item-image bg--cover"
                          style="background-image:url(/assets/images/cases/demo/fred/prev.jpg.webp)"
                          role="img" aria-label="Проект FRED"></div>
                        <div class="work-logo">
                          <span>FRED</span>
                        </div>
                      </div>
          ...
          <div class="row element-animation-up">
            <div class="col-100">
              <article>
                <h2 class="h2-title deco-line">Техническая оптимизация и рост продаж</h2>
                <p>
                  Эти кейсы демонстрируют, как грамотная <strong>верстка сайтов</strong> делает бизнес удобным для клиента. Каждый проект прошел оптимизацию под Google PageSpeed, отлично работает на мобильных и имеет чистый, <strong>валидный код</strong>. Я создаю адаптивные темы для CMS, которые легко поддерживать.
                  Хотите сайт, который усилит ваш бренд? Давайте обсудим задачу.
                </p>
                <p>
                  <span class="color-white font-middle">Нужен похожий результат?</span>
                  Свяжитесь для бесплатной консультации. Мы разработаем стратегию <strong>внедрения AI</strong> или обновления сайта, которая выведет ваш бизнес на новый уровень. Начните свой путь к цифровой трансформации уже сегодня!
                </p>
              </article>
              <!-- Блок кнопок -->
