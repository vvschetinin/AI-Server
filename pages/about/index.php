      ...
      <section class="hero hero--small">
        <div class="hero-container">
          <div class="hero-content">
            <h1 class="hero-title">
              <!-- Четкая навигация: О чем страница -->
              <span class="sectorname">Биография и профессиональный опыт</span>
              Full-stack разработчик Владлен Щетинин
              <!-- Цифры и ключевые сферы для авторитетности -->
              <span>8+ лет в веб-разработке и внедрении AI-решений</span>
            </h1>
            <div class="hero-buttons">
              <!-- Меняем кнопки на более логичные для раздела "Обо мне" -->
              <!-- Вместо продажи услуг — сначала показать экспертность (Кейсы), потом Контакты -->
              <a class="btn btn--purple" href="/cases/">Посмотреть портфолио</a>
              <a class="btn btn--white" href="/contacts/">Связаться со мной</a>
            </div>
          </div>
        </div>
        ...
        <div class="container--middle">
          <div class="row content-block element-animation-up">
            <div class="col-100 col-lg-35 col-xl-25">
              <!-- Меняем "Немного о себе" на более солидный заголовок -->
              <h2 class="h2-title deco-line mb-1 mb-0--lg">Мой путь в IT и веб-разработке</h2>
            </div>
            <article class="col-100 col-lg-65 col-xl-75">
              <h2 class="p-article"><?php echo $greeting; ?> <br>Меня зовут Владлен Щетинин.</h2>
              <p>
                Я — <strong>Full-stack разработчик</strong>, который прошел путь от верстки простых лендингов до архитектуры сложных веб-сервисов.
                За 8 лет я реализовал более 30 проектов: от интернет-магазинов на 1С-Битрикс до <strong>AI-ботов</strong> с интеграцией нейросетей.
                Для меня код — это не просто строки символов, а инструмент для решения реальных проблем бизнеса.</p>
              <p>
                В IT меня привела страсть к сложным задачам. Меня всегда вдохновляли технологии "переднего края" (Bleeding Edge), поэтому сейчас я полностью сфокусирован на <strong>Artificial Intelligence (AI)</strong>. Я убежден: нейросети — это новая электрификация. Кто внедрит их первым, тот выиграет рынок.
              </p>
              <p>
                При всей любви к технологиям, я ценю Work-Life Balance. Активный отдых помогает мне перезагружать мозг и находить нестандартные решения для ваших проектов.
              </p>
            </article>
          </div>
          <!-- Картинки (Оптимизированы для доступности и SEO) -->
          <div class="row content-block">
            <div class="col-100 about-grid">
              <!-- Фото 1: Экстрим/Хобби -->
              <div class="card card1 bg--cover" style="background-image:url(/assets/images/about/myfoto-1.webp)"
                role="img" aria-label="Владлен Щетинин: Прыжок с парашютом (активный отдых)">
                <div class="textcard">
                  <p>Экстрим и драйв</p>
                </div>
              </div>
              ...
              <div class="card card2 bg--cover" style="background-image:url(/assets/images/about/myfoto-2.webp)"
                role="img" aria-label="Портрет разработчика Владлена Щетинина">
                <div class="textcard">
                  <p>Личный подход</p>
                </div>
              </div>
              <!-- Фото 3: Работа/Интересы -->
              <div class="card card3 bg--cover" style="background-image:url(/assets/images/about/myfoto-3.webp)"
                role="img" aria-label="Увлечение технологиями и AI">
                <div class="textcard">
                  <p>В ногу со временем</p>
                </div>
              </div>
            </div>
          </div>
          <!-- Текстовый блок (Философия и Подход) -->
          <div class="row mt-3 element-animation-up">
            <article class="col-100">
              <p>
                <strong>Почему я делаю ставку на AI?</strong> Углубившись в эту сферу, я понял: малый бизнес часто страдает от рутины и нехватки рук. Моя миссия — дать вам доступные AI-инструменты (автоответчики, генераторы контента, аналитику), которые раньше были доступны только корпорациям.
              </p>
              <h2 class="h2-title mt-2">Мои принципы работы:</h2>
              <ul class="competences-list mt-1 mb-2">
                <li><strong>Прозрачность:</strong> Вы всегда знаете, за что платите (понятные сметы и отчеты).</li>
                <li><strong>Техническая эстетика:</strong> Пишу чистый, поддерживаемый код, который легко масштабировать.</li>
                <li><strong>Работа на результат:</strong> Не "делаю сайт", а решаю задачу (привлечь клиентов, ускорить загрузку).</li>
              </ul>
              <p>
                Я знаю боли предпринимателей: "пропал фрилансер", "сайт лег", "бюджет слили". Со мной такого не бывает. Я работаю официально, соблюдаю дедлайны и предоставляю
                <strong>техническую поддержку</strong> после сдачи проекта. Мой опыт работы с десятками ниш (от локального сервиса до e-commerce) позволяет мне говорить с вами
                на одном языке.
              </p>
              <p>
                <em>Открыт к амбициозным проектам. Если вы хотите внедрить AI или обновить веб-ресурс — я готов стать вашим техническим партнером.</em>
              </p>
              <!-- Блок кнопок -->
              <div class="button-wrap flex justify-center mt-2 mt-3--lg">
                <button class="start-project-btn display-inline-block js-startproject">Обсудить ваш проект</button>
              </div>
            </article>
          </div>
        </div>
