...
$attractiveFieldNames = [
    'email', 'email_address', 'contact_email', 'user_email', 'customer_email',
    'phone', 'telephone', 'contact_phone', 'user_phone', 'mobile_phone',
    'fax', 'contact_fax', 'website', 'url', 'homepage', 'site_url', 'profile_url',
    'name', 'fullname', 'user_name', 'first_name', 'last_name', 'nickname',
    'username', 'login', 'address', 'street_address', 'address_line_1',
    'address_line_2', 'city', 'state', 'province', 'zip_code', 'postal_code',
    'country', 'comment', 'message', 'your_message', 'enquiry', 'inquiry',
    'text', 'details', 'subject', 'topic', 'feedback', 'review', 'question',
    'notes', 'additional_info', 'author', 'company', 'job_title', 'position', 'user_id'
];
