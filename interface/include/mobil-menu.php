...
$array_menu[$i]['url'] = '/pages/about/';
$array_menu[$i++]['name'] = 'Обо мне';

$array_menu[$i]['url'] = '/pages/services/';
$array_menu[$i++]['name'] = 'Услуги';

$array_menu[$i]['url'] = '/pages/cases/';
$array_menu[$i++]['name'] = 'Кейсы и результаты';

$array_menu[$i]['url'] = '/pages/faq/';
$array_menu[$i++]['name'] = 'FAQ';

$array_menu[$i]['url'] = '/pages/blog/';
$array_menu[$i++]['name'] = 'Блог';

$array_menu[$i]['url'] = '/pages/contacts/';
