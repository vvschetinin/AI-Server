                ...
                <div class="myslider-wrapper">
                  ...
                  <div class="slider-item">
                    <article class="service-item">
                      ...
                      <p>
                        Оказываю помощь в анализе данных с применением AI. Консультирую в выборе AI-платформ,
                        осуществляю техническую поддержку AI-решений. Помощь в разработка маркетинговых стратегий с
                        использованием AI-аналитики и анализа конкурентной среды.
                      </p>
                    </article>
                  </div>
                </div>
